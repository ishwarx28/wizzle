...
type WizzleClientEnv = {
  readonly WIZZLE_ACTIVE_TURN_PRESSURE_PERCENT?: string;
  readonly WIZZLE_COMPACTION_TRIGGER_PERCENT?: string;
  readonly WIZZLE_COMPACTED_CONTEXT_TOKENS?: string;
  readonly WIZZLE_CONTEXT_SAFETY_PERCENT?: string;
  ...
  readonly WIZZLE_POST_COMPACTION_TARGET_PERCENT?: string;
  ...
  readonly WIZZLE_CONFIG_URL?: string;
};
